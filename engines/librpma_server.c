...
static struct fio_option options[] = {
	{
		...
		.off1	= offsetof(struct librpma_server_options, listen_ip),
...

	{
		...
		.type	= FIO_OPT_STR_STORE,
		.off1	= offsetof(struct librpma_server_options, listen_port),
...
FIO_STATIC struct ioengine_ops ioengine = {
	...
	.options		= options,
	.option_struct_size	= sizeof(struct librpma_server_options),
};
