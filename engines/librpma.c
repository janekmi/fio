 ...
 *
 * It's client part of the engine. See also: librpma_server
 *
...
static struct fio_option options[] = {
	{
		...
		.off1	= offsetof(struct fio_librpma_options, server_ip),
	...
	},
	{
		...
		.type	= FIO_OPT_STR_STORE,
		.off1	= offsetof(struct fio_librpma_options, server_port),
...
{
	struct librpmaio_data *rd = td->io_ops_data;
	struct fio_librpma_options *o = td->eo;
...
FIO_STATIC struct ioengine_ops ioengine = {
	...
	.options		= options,
	.option_struct_size	= sizeof(struct fio_librpma_options),
};
